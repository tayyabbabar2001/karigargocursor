...
const styles = StyleSheet.create({
  ...
  jobTitle: { fontSize: 20, fontWeight: '500', flex: 1 },
  categoryBadge: {
  ...
  detailValue: { color: '#333', fontSize: 16, fontWeight: '500' },
  ...
  customerAvatarText: { color: '#fff', fontSize: 20, fontWeight: '500' },
  customerDetails: { flex: 1 },
  customerName: { fontSize: 16, fontWeight: '500', marginBottom: 4 },
