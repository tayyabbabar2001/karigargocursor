...
export function EditPhone({ context }: { context: AppContextType }) {
  const [phone, setPhone] = useState(context.currentUser?.phone || '0300-1234567');
    ...
    return (
      <View style={styles.confirmationContainer}>
        ...
        >
          ...
          <Text style={styles.confirmationTitle}>Phone Updated!</Text>
          <Text style={styles.confirmationText}>Your phone number has been changed successfully</Text>
        </Animated.View>
      </View>
    );
  }
