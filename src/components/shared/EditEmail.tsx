...
export function EditEmail({ context }: { context: AppContextType }) {
  const [email, setEmail] = useState(context.currentUser?.email || 'ahmed@example.com');
    ...
    return (
      <View style={styles.confirmationContainer}>
        ...
        >
          ...
          <Text style={styles.confirmationTitle}>Email Updated!</Text>
          <Text style={styles.confirmationText}>Your email has been changed successfully</Text>
        </Animated.View>
      </View>
    );
  }
